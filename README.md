...
built-in JSON parsing module. simpleion module performance is improved by an optional [C extension](https://github.com/amzn/ion-python/blob/c-extension-beta/C_extension.md).
...
called `ion-tests` which holds test data used by `ion-python`'s unit tests and `ion-c`.
